...
namespace JokeWebAppMVC.Controllers
{
    public class JokesController : Controller
    {
        ...
        // POST: Jokes/ShowSearchResluts
        public async Task<IActionResult> ShowSearchResluts(String SearchPhrase)
        {
            //return the only joke that contain the SearchPhrase
        ...
        // GET: Jokes/Create
        //[Authorize] which is mean we're not gonna doing any creating form unless you logged in !!!
